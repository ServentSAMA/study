...
'''
pool = redis.ConnectionPool(host='127.0.0.1', password='', max_connections=5)
...
#         print(item['channel'].decode('utf8'))
#         print(item['data'].decode('utf8'))

while True:
    message = p.get_message()
    if message and message['type'] == 'message':
        # {'type': 'message', 'pattern': None, 'channel': b'my-first-channel', 'data': b'1'}
        print(message)
        print(message['type'])
